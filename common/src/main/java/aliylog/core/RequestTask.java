...
import aliylog.core.parser.ResponseParser;
import aliylog.core.retry.RetryHandler;
import aliylog.core.retry.RetryType;
...
public class RequestTask<T extends Result> implements Callable<T> {
    ...
    public RequestTask(RequestMessage message, ResponseParsers.PostLogResponseParser parser, ExecutionContext context, int maxRetry) {
